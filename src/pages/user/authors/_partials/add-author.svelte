<script lang="ts">
  ...
  let errors: Record<keyof Author, string[]> | null = null

  const dispatch = createEventDispatcher<{ submit: Author }>()
  ...
  <Dialog.Portal>
    ...
    >
      ...
      <Dialog.Title class="space-y-1 mb-4">
        <h2 class="text-base font-semibold">Add Author</h2>
      </Dialog.Title>

      <form
        action="/api/author?add"
        method="post"
        class="space-y-4"
